...
### tBodyAccJerk
  The body linear acceleration was derived in time to obtain Jerk signals (tBodyAccJerk-XYZ).
...
### tBodyAccJerk
  The body angular velocity was derived in time to obtain Jerk signals (tBodyGyroJerk-XYZ).
...
### tBodyAccMag
  The magnitude of tBodyAccMag signals were calculated using the Euclidean norm.
...
### tGravityAccMag
  The magnitude of tGravityAccMag signals were calculated using the Euclidean norm.
...
### tBodyAccJerkMag
  The magnitude of tBodyAccJerkMag signals were calculated using the Euclidean norm.
...
### tBodyGyroMag
  The magnitude of tBodyGyroMag signals were calculated using the Euclidean norm.
...
### tBodyGyroJerkMag
  The magnitude of tBodyGyroJerkMag signals were calculated using the Euclidean norm.
...
### fBodyAcc
  A Fast Fourier Transform (FFT) was applied to producing fBodyAcc-XYZ.
...
### fBodyAccJerk
  A Fast Fourier Transform (FFT) was applied to producing fBodyAccJerk-XYZ.
